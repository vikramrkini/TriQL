...
CREATE TABLE IF NOT EXISTS `despatch` (
  `DES_NUM` varchar(6) NOT NULL  '',
  `DES_DATE` date  NULL,
  `DES_AMOUNT` decimal(12,2)  NULL,
  `ORD_NUM` decimal(6,0)  NULL,
  `ORD_DATE` date  NULL,
...
CREATE TABLE IF NOT EXISTS `studentreport` (
  ...
  `SEMISTER` varchar(5)  NULL,
  `CLASS_ATTENDED` decimal(25,0)  NULL,
